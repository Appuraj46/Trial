  ...
  const organizers = [
    {
      ...
      bio: 'Leading the vision and strategic direction of Nexathon 2024'
    },
    {
      ...
      <div className="container mx-auto px-4">
        ...
        >
          <h2 className="text-4xl md:text-5xl font-bold text-gray-800 mb-6 font-orbitron">
            Meet Our <span className="bg-gradient-to-r from-cyan-600 to-purple-600 bg-clip-text text-transparent">Team</span>
          </h2>
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            The dedicated individuals working tirelessly to make Nexathon 2024 an unforgettable experience
          </p>
        </motion.div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            {volunteers.map((volunteer, index) => (
              ...
              >
                ...
                <h5 className="font-bold text-gray-800 text-sm mb-1">{volunteer.name}</h5>
        ...
        >
          <div className="bg-gradient-to-r from-yellow-500/20 to-orange-500/20 rounded-2xl p-8 border border-yellow-500/30">
            <h3 className="text-2xl font-bold mb-4 text-gray-800">Special Thanks</h3>
            <p className="text-gray-700 max-w-3xl mx-auto">
              We extend our heartfelt gratitude to the faculty, staff, and administration of 
              Shree Devi Institute of Technology for their unwavering support in making Nexathon 2024 possible. 
              Together, we're building a platform for innovation and excellence.
            </p>
          </div>
        </motion.div>
      </div>
